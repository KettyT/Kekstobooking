...
import './App.css';
import MapCmp from "./main/MapCmp";
        ...
        <main>
          ...
          <section className="notice">
            ...
            <form className="ad-form" method="post" encType="multipart/form-data" autoComplete="off">
              <fieldset className="ad-form-header">
                ...
                <div className="ad-form-header__upload">
                  ...
                  <div className="ad-form__field">
                    ...
                    <label className="ad-form-header__drop-zone" htmlFor="avatar">Загрузить<br/>фото...</label>
                  </div>
                  <p className="ad-form-header__info">Заполните все обязательные поля, назначьте цену, загрузите аватар
                    и
                    фото жилья. Придумайте интересное описание. Оно сделает объявление более живым и привлекательным.
              ...
              <fieldset className="ad-form__element ad-form__element--wide">
                <label className="ad-form__label" htmlFor="address">Адрес (координаты)</label>
              ...
              <fieldset className="ad-form__element">
                <label className="ad-form__label" htmlFor="room_number">Количество комнат</label>
              ...
              <fieldset className="ad-form__element ad-form__element--wide">
                <label className="ad-form__label">Фотография жилья</label>
                <div className="ad-form__photo-container">
                  <div className="ad-form__upload">
                    ...
                    <label htmlFor="images" className="ad-form__drop-zone">Загрузить<br/>фото...</label>
                  </div>
